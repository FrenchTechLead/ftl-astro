...
<Image w="853" h="348" src={img2.src} t="Stack Vs Heap" />
...
<Image w="669" h="347" src={img3.src} t="Stack Vs Heap 2" />
...
```
<Image w="1316" h="283" src={img4.src} t="Stack Timeline" />
...
```
<Image w="669" h="347" src={img5.src} t="Stack and Heap interaction" />
...
<Image w="640" h="314" src={img6.src} t="StackOverflowError" />
...
<Image w="740" h="268" src={img7.src} t="OutOfMemoryError" />
...
## Memory Leaks
<Image w="858" h="494" src={img8.src} t="intellij's Profiler" />
...
<Image w="1264" h="494" src={img9.src} t="intellij's Profiler" />
...
<Image w="1266" h="477" src={img10.src} t="intellij's Profiler result" />

...
<Image src={img1.src} t='Demande d IP fixe pour Freebox' solo={true}/>
...
<Image src={img2.src} t='Redirection du port 80' solo={true}/>
<Image src={img3.src} t='Redirection du port 443' solo={true}/>
...
Exemple:
<Image src={img4.src} t='DNS A Record sur dnsimple.com' solo={true}/>

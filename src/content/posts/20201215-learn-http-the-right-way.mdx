...
<Image w="624" h="214" src={img1.src} t="Client/Server Architecture" solo="true" />
...
<Image w="624" h="214" src={img2.src} t="Example of HTTP Request" solo="true" />
...
<Image w="1110" h="958" src={img3.src} t="Example of HTTP Request" solo="true" />

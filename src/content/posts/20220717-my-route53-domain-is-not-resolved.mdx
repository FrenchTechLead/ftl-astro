...
<Image w="1472" h="851" src={img1.src} t="AWS Hosted Zone Records" solo="true" />
...
<Image w="1063" h="273" src={img2.src} t="AWS Registred Domains Tab" solo="true" />
...
<Image w="649" h="444" src={img3.src} t="DNS Propagation Map" solo="true" />
